...
class ContextManager:
    ...
    def prepare_handoff_context(self, user_id: str, source_agent: str, target_agent: str, 
                               handoff_data: Dict[str, Any] = None) -> Dict[str, Any]:
        """
    ...
    def update_workflow_context(self, user_id: str, workflow_id: str, workflow_data: Dict[str, Any]):
        """
