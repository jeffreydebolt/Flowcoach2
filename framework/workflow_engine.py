...
class WorkflowEngine:
    ...
    def start_workflow(
        self, workflow_id: str, user_id: str, initial_context: dict[str, Any] = None
    ) -> WorkflowExecution:
        """
    ...
    def _execute_step_action(
        self, agent, step: WorkflowStep, context: dict[str, Any]
    ) -> dict[str, Any]:
    ...
    def _complete_step(
        self, execution: WorkflowExecution, step: WorkflowStep, result: dict[str, Any]
    ):
