...
class TodoistService:
    ...
    def get_tasks(self, filter_string: Optional[str] = None) -> List[Dict[str, Any]]:
        """
    ...
    def add_task_with_gtd_processing(self, content: str, **kwargs) -> Optional[Dict[str, Any]]:
        """
        ...
        processed_content = re.sub(r'\b(2|two|10|ten|30\+?|thirty\+?)\s*min\b|\b(quick|fast|short|medium|long|big)\b', '', content, flags=re.IGNORECASE).strip()
        ...
        # Common action verbs
        action_verbs = [
            "call", "email", "write", "draft", "create", "design", "develop",
            "review", "edit", "update", "research", "schedule", "book", "buy",
            "order", "prepare", "plan", "organize", "clean", "fix", "install"
        ]
