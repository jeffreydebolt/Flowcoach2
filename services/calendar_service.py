...
class CalendarService:
    ...
    def find_focus_blocks(
        ...
        try:
            ...
            focus_blocks = self._calculate_focus_blocks(
                events, work_start_hour, work_end_hour, min_block_minutes
            )
    ...
    def delete_event(self, event_id: str, user_id: str, calendar_id: str = "primary") -> bool:
        """
            ...
            for days_ahead in range(7):
                ...
                if work_hours_only:
                    focus_blocks = self.find_focus_blocks(
                        user_id=user_id, date=search_date, min_block_minutes=duration_minutes
                    )
                else:
