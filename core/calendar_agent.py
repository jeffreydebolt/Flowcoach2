...
class CalendarAgent(BaseAgent):
    ...
    def __init__(self, config: Dict[str, Any], services: Dict[str, Any]):
        ...
        if not self.calendar_service:
            self.logger.error("Calendar service not available. Calendar agent functionality will be limited.")
        
        # Calendar-related keywords for intent detection
        self.calendar_keywords = [
            "calendar", "schedule", "meeting", "appointment", "event", 
            "free time", "availability", "focus", "block", "time"
        ]
    ...
    def process_message(self, message: Dict[str, Any], context: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        if any(keyword in text for keyword in ["today", "schedule", "calendar"]) and any(keyword in text for keyword in ["show", "what", "summary"]):
        ...
        if "schedule" in text and any(keyword in text for keyword in ["task", "todo", "to-do", "to do"]):
        ...
        return {
            ...
            "commands": [
                ...
                },
                {
                    ...
                    "examples": ["Schedule the documentation task", "Add time for project planning"]
                }
            ]
        }
