...
class BaseAgent(ABC):
    ...
    def _handle_command(self, command_text: str, message: Dict[str, Any], context: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _handle_help(self) -> Dict[str, Any]:
        ...
        if not self.commands:
            return {
                "response_type": "help",
                "message": f"{self.name} has no commands available."
            }
    ...
    def handoff_to(self, target_agent_id: str, context: Dict[str, Any], message: str = None) -> Dict[str, Any]:
        """
