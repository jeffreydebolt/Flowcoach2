...
class GTDTaskAgent(BaseAgent):
    ...
    def _extract_time_estimate(self, text: str) -> str | None:
    ...
    def _suggest_project_breakdown(
        self, task: str, user_id: str, reason: str = None
    ) -> dict[str, Any]:
        ...
        return {
            ...
            "context_update": {"pending_task": task, "expecting_project_response": True},
        }
    ...
    def _handle_project_response(self, response: str, user_id: str) -> dict[str, Any]:
        ...
        if response_lower in ["breakdown", "break it down", "yes", "y"]:
            ...
            return self.handoff_to(
                "gtd-planning-agent",
                {"task": pending_task, "user_id": user_id, "source": "project_detection"},
    ...
    def _create_todoist_task(
        self, task_content: str, time_estimate: str, context: str
    ) -> dict[str, Any]:
