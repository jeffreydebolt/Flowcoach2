...
class InteractiveGTDDemo:
    ...
    def _load_agents(self):
        ...
        # Load PlanningAgent
        planning_agent = GTDPlanningAgent.from_yaml("agents/gtd_planning_agent.yaml", self.mock_services)
    ...
    def _process_user_input(self, user_input: str):
        ...
        if user_input.startswith('*'):
            ...
            if agent:
                ...
                response = {"message": "No agent could handle this message. Try using a command like *help"}
    ...
    def _try_command_with_agents(self, message: dict):
        ...
        return {
            "message": f"❌ Unknown command: {message['text']}. Try *help with any agent."
        }
