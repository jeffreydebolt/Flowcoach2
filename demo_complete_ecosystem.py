...
class CompleteGTDEcosystemDemo:
    ...
    def _load_agents(self):
        ...
        try:
            ...
            task_agent = GTDTaskAgent.from_yaml(
                "agents/gtd_task_agent.yaml",
                self.mock_services
            )
            ...
            planning_agent = GTDPlanningAgent.from_yaml(
                "agents/gtd_planning_agent.yaml",
                self.mock_services
            )
    ...
    def _demo_project_breakdown(self):
        ...
        response = self.project_workflow.start_project_breakdown(
            initial_request=project_request,
    ...
    def _demo_complete_ecosystem(self):
        ...
        breakdown_response = self.project_workflow.start_project_breakdown(
            initial_request=complex_project,
            user_id=self.demo_user,
            source_agent="ecosystem_demo"
        )
        ...
        mock_completion = {
            ...
            "tasks_created": 12,
            "next_actions": [
                {"content": "Research competitor task management apps", "context": "@computer", "time_estimate": "30min"},
                {"content": "Define core feature requirements", "context": "@computer", "time_estimate": "20min"},
                {"content": "Sketch initial UI wireframes", "context": "@computer", "time_estimate": "45min"},
                {"content": "Set up development environment", "context": "@computer", "time_estimate": "15min"}
            ]
        }
    ...
    def _show_agent_capabilities(self):
        ...
        print(f"   • Workflow Engine: 2 workflows available")
        print(f"   • Context Manager: Cross-agent state management")
        print(f"   • BMAD Patterns: Command routing, YAML config, structured workflows")
    ...
    def _simulate_quick_planning(self, project: str):
        ...
        mock_planning_result = {
            ...
            "next_actions": [
                {"content": f"Research requirements for {project}", "context": "@computer", "time_estimate": "30min"},
                {"content": f"Create project roadmap", "context": "@computer", "time_estimate": "20min"},
                {"content": f"Set up initial development structure", "context": "@computer", "time_estimate": "15min"}
            ]
        }
