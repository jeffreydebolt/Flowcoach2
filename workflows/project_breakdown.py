...
class ProjectBreakdownWorkflow:
    ...
    def __init__(self, workflow_engine: WorkflowEngine, agent_registry: AgentRegistry, context_manager: ContextManager):
    ...
    def start_project_breakdown(self, initial_request: str, user_id: str, source_agent: str = "user") -> Dict[str, Any]:
        """
    ...
    def _execute_complexity_detection(self, execution, initial_request: str) -> Dict[str, Any]:
        ...
        complexity_indicators = [
            ...
            any(word in initial_request.lower() for word in [
                "website", "project", "launch", "organize", "implement", 
                "develop", "create", "design", "plan", "strategy"
            ]),
            any(word in initial_request.lower() for word in [
    ...
    def handle_planning_completion(self, user_id: str, planning_result: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def _execute_task_creation(self, execution, next_actions: List[Dict[str, Any]]) -> Dict[str, Any]:
...
def register_project_breakdown_workflow(workflow_engine: WorkflowEngine, agent_registry: AgentRegistry, context_manager: ContextManager):
