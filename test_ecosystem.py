...
class EcosystemTester:
    ...
    def test_load_agents(self):
        ...
        print(f"   Loaded 3 agents successfully")
    ...
    def test_agent_commands(self):
        ...
        help_response = planning_agent.process_message({"text": "*help", "user": self.test_user}, {})
        assert help_response["response_type"] == "help"
        ...
        print(f"   All agent commands registered and working")
    ...
    def test_agent_communication(self):
        ...
        try:
            ...
            can_handle_planning = planning_agent.can_handle({"text": "help me break down this complex project"})
            ...
            print(f"   Agent communication patterns working correctly")
        except Exception as e:
    ...
    def test_load_workflows(self):
        ...
        print(f"   2 workflows registered successfully")
    ...
    def test_project_breakdown(self):
        ...
        mock_planning_result = {
            ...
            "next_actions": [
                {"content": "Research app requirements", "context": "@computer", "time_estimate": "30min"},
                {"content": "Design user interface", "context": "@computer", "time_estimate": "45min"}
            ]
        }
        ...
        print(f"   Project breakdown workflow functioning")
    ...
    def test_weekly_review(self):
        ...
        # Start weekly review
        response = review_workflow.start_weekly_review(
            user_id=self.test_user,
            review_type="quick"
        )
        ...
        print(f"   Weekly review workflow functioning")
    ...
    def test_framework_integration(self):
        ...
        print(f"   Framework integration working correctly")
