...
class WeeklyReviewWorkflow:
    ...
    def start_weekly_review(self, user_id: str, review_type: str = "full", scheduled: bool = False) -> Dict[str, Any]:
        """
    ...
    def _engage_planning_agent_for_health_check(self, execution, project_concerns: str) -> Dict[str, Any]:
    ...
    def _complete_review_workflow(self, execution, insights_response: Dict[str, Any] = None) -> Dict[str, Any]:
        """Complete the weekly review workflow."""
        logger.info(f"Completing weekly review workflow {execution.workflow_id}")
        
        # Calculate review statistics
        completed_at = datetime.now()
        started_at = datetime.fromisoformat(execution.context.get("started_at", completed_at.isoformat()))
...
def register_weekly_review_workflow(workflow_engine: WorkflowEngine, agent_registry: AgentRegistry, context_manager: ContextManager):
