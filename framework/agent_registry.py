...
class AgentRegistry:
    ...
    def load_agent_from_yaml(self, yaml_path: str, agent_class: Type[BaseAgent] = None) -> BaseAgent:
        """
    ...
    def find_agent_for_message(self, message: Dict[str, Any]) -> Optional[BaseAgent]:
        """
    ...
    def route_message(self, message: Dict[str, Any], context: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        """
            ...
            for agent_id, agent in self.agents.items():
                if hasattr(agent, 'commands') and command_name in agent.commands:
                    try:
                        ...
                        logger.error(f"Error executing command '{command_name}' on agent '{agent_id}': {e}")
                        return {
