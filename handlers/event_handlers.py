        ...
        try:
            ...
            if communication_agent:
                response = communication_agent.process_message(
                    {"user": user_id, "text": text}, {}  # Empty context for now
                )
                ...
                if response:
                    ...
                    say(
                        "I'm not sure how to help with that in a channel. Try sending me a direct message!"
                    )
            else:
                say(
                    "I'm here to help with your productivity! Send me a direct message to get started."
                )
